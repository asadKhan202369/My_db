...
const page = () => {
  ...
  const GetDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/${params.name}/${params.id}?api_key=24353009232f42a282a3a6abc9dccee7`
  ...
  const GetCast = async () => {
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/${params.name}/${params.id}/credits?api_key=24353009232f42a282a3a6abc9dccee7`
        // `https://api.themoviedb.org/3/movie/${params.id}/credits?api_key=24353009232f42a282a3a6abc9dccee7`
        // `https://api.themoviedb.org/3/movie/${params.id}/videos?api_key=24353009232f42a282a3a6abc9dccee7`
      );
      setcasts(data.cast);
  ...
  const GetBackdrops = async () => {
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/${params.name}/${params.id}/images?api_key=24353009232f42a282a3a6abc9dccee7`
        // `https://api.themoviedb.org/3/movie/${params.id}/videos?api_key=24353009232f42a282a3a6abc9dccee7`,
        // `https://api.themoviedb.org/3/movie/${params.id}/credits?api_key=24353009232f42a282a3a6abc9dccee7`
        // `https://api.themoviedb.org/3/movie/${params.id}/videos?api_key=24353009232f42a282a3a6abc9dccee7`
      );
